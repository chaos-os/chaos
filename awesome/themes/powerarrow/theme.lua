...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            pl(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, "#ababab"),
            pl(wibox.widget { neticon, net.widget, layout = wibox.layout.align.horizontal }, "#ababab"),
